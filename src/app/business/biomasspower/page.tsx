...
const fuelItems = [
  {
    ...
    points: ["現地工場との直接提携", "東南アジア各地域から調達", "上位発熱量 adv.4000kcal"],
  },
  {
    name: "炭化PKS",
  ...
  },
  {
    ...
    // 認証表記（FSC-COC）は裏付け確認まで一旦非表示（元: FSC-COC認証取得工場との提携）
    points: ["現地工場との直接提携", "東南アジア各地域から調達", "上位発熱量 adv.4100kcal"],
  },
];
...
const supplySteps = [
  {
    // 認証名（RSPO/FSC-COC）は裏付け確認まで一旦非表示
    title: "持続可能性に配慮した調達",
    text: "環境・持続可能性に配慮した供給元を選定します。",
  },
  {
    title: "直接契約で安定供給",
