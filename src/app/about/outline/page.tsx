...
export const metadata: Metadata = {
  title: "会社概要 | 諾亜建設株式会社",
  description:
    "諾亜建設株式会社の会社名、設立、所在地、連絡先、代表者、資本金、事業内容、登録・許可、主要取引先などの会社概要です。",
};

const companyRows = [
  { label: "会社名", value: "諾亜建設株式会社" },
  { label: "設立", value: "2018年10月26日" },
  {
    label: "所在地",
  ...
  { label: "資本金", value: "99,000,000円" },
  {
    label: "事業内容",
    value:
      "発電所の設備に関して、設計の段階から機器選定、調達、施工、試運転まで一貫した業務を提供。気候変動対策の一環として脱炭素事業に取り組む。",
  },
  {
    label: "登録・許可",
    value:
  ...
  },
  {
    label: "主要取引先",
    value:
      "王子エンジニアリング株式会社、伊藤忠エネクス株式会社、イーレックス株式会社、JFEエンジニアリング株式会社",
  },
  {
    label: "取引電力会社",
    value: "九州電力株式会社、中部電力株式会社、東北電力株式会社",
  },
